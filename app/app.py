...
def api():
    ...
    for nutrientValue in nutrientValues:
        ...
        nutrientValueDict["carbohydrate_g"] = Decimal(nutrientValue.carbohydrate_g)
        nutrientValueDict["sugars_total_g"] = Decimal(nutrientValue.sugars_total_g)
        nutrientValueDict["fiber_total_dietary_g"] = Decimal(nutrientValue.fiber_total_dietary_g)
        nutrientValueDict["total_fat_g"] = Decimal(nutrientValue.total_fat_g)
        nutrientValueDict["fatty_acids_total_saturated_g"] = Decimal(nutrientValue.fatty_acids_total_saturated_g)
        nutrientValueDict["fatty_acids_total_monounsaturated_g"] = Decimal(nutrientValue.fatty_acids_total_monounsaturated_g)
        nutrientValueDict["fatty_acids_total_polyunsaturated_g"] = Decimal(nutrientValue.fatty_acids_total_polyunsaturated_g)
        nutrientValueDict["cholesterol_mg"] = Decimal(nutrientValue.cholesterol_mg)
        nutrientValueDict["retinol_mcg"] = Decimal(nutrientValue.retinol_mcg)
        nutrientValueDict["vitamin_a_rae_mcg_rae"] = Decimal(nutrientValue.vitamin_a_rae_mcg_rae)
        nutrientValueDict["carotene_alpha_mcg"] = Decimal(nutrientValue.carotene_alpha_mcg)
        nutrientValueDict["carotene_beta_mcg"] = Decimal(nutrientValue.carotene_beta_mcg)
        nutrientValueDict["cryptoxanthin_beta_mcg"] = Decimal(nutrientValue.cryptoxanthin_beta_mcg)
        nutrientValueDict["lycopene_mcg"] = Decimal(nutrientValue.lycopene_mcg)
        nutrientValueDict["lutein__zeaxanthin_mcg"] = Decimal(nutrientValue.lutein__zeaxanthin_mcg)
        nutrientValueDict["thiamin_mg"] = Decimal(nutrientValue.thiamin_mg)
        nutrientValueDict["riboflavin_mg"] = Decimal(nutrientValue.riboflavin_mg)
        nutrientValueDict["niacin_mg"] = Decimal(nutrientValue.niacin_mg)
        nutrientValueDict["vitamin_b6_mg"] = Decimal(nutrientValue.vitamin_b6_mg)
        nutrientValueDict["folic_acid_mcg"] = Decimal(nutrientValue.folic_acid_mcg)
        nutrientValueDict["folate_food_mcg"] = Decimal(nutrientValue.folate_food_mcg)
        nutrientValueDict["folate_dfe_mcg_dfe"] = Decimal(nutrientValue.folate_dfe_mcg_dfe)
        nutrientValueDict["folate_total_mcg"] = Decimal(nutrientValue.folate_total_mcg)
        nutrientValueDict["choline_total_mg"] = Decimal(nutrientValue.choline_total_mg)
        nutrientValueDict["vitamin_b12_mcg"] = Decimal(nutrientValue.vitamin_b12_mcg)
        nutrientValueDict["vitamin_b12_added_mcg"] = Decimal(nutrientValue.vitamin_b12_added_mcg)
        nutrientValueDict["vitamin_c_mg"] = Decimal(nutrientValue.vitamin_c_mg)
        nutrientValueDict["vitamin_d_d2__d3_mcg"] = Decimal(nutrientValue.vitamin_d_d2__d3_mcg)
        nutrientValueDict["vitamin_e_alphatocopherol_mg"] = Decimal(nutrientValue.vitamin_e_alphatocopherol_mg)
        nutrientValueDict["vitamin_e_added_mg"] = Decimal(nutrientValue.vitamin_e_added_mg)
        nutrientValueDict["vitamin_k_phylloquinone_mcg"] = Decimal(nutrientValue.vitamin_k_phylloquinone_mcg)
        nutrientValueDict["calcium_mg"] = Decimal(nutrientValue.calcium_mg)
        nutrientValueDict["phosphorus_mg"] = Decimal(nutrientValue.phosphorus_mg)
        ...
        nutrientValueDict["theobromine_mg"] = Decimal(nutrientValue.theobromine_mg)
    ...
    for portionsAndWeight in portionsAndWeights:
        ...
        portionsAndWeightsDict["portion_weight_g"] = Decimal(portionsAndWeight.portion_weight_g)
